<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('home') }}" class="app-brand-link">
            <img src="{{ asset('logo-black.png') }}" alt="{{ config('app.name') }}" height="50">
        ...
        @if(auth()->user()->role == 'admin')
            <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('reference.*') ? 'active open' : '' }}">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('reference.bidang.*') ? 'active' : '' }}">
                        <a href="{{ route('reference.bidang.index') }}" class="menu-link">
